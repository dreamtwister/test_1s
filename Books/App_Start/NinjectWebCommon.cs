...
namespace Books.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            kernel.Bind<IRepository<Book>>().To<BookRepository>().WithConstructorArgument("path", "BookStorage\\");
            kernel.Bind<IImageStorage>().To<ImageStorage>().WithConstructorArgument("path", "BookStorage\\");
